This is a Project Folder for "Project validate list"

Go employee list page and validate given tabs
...
--------------------------
pytest -v -s --capture=sys --html=C:\Users\premk\workspace\Project_Four\report\test_prem.html testprem.py
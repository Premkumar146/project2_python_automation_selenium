This is a Project Folder for "Project_Emergency"

Go to Emergencydetail and fill
...
--------------------------
pytest -v -s --capture=sys --html=C:\Users\premk\workspace\Project_Seven\report\test_prem.html testprem.py
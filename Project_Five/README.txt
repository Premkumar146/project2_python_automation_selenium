This is a Project Folder for "Project_Personal details"

Go to personal detail and fill
...
--------------------------
pytest -v -s --capture=sys --html=C:\Users\premk\workspace\Project_Five\report\test_prem.html testprem.py
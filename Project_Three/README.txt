This is a Project Folder for "Project add employee"

creat login and add employee in PIM
...
--------------------------
pytest -v -s --capture=sys --html=C:\Users\premk\workspace\Project_Three\report\test_prem.html testprem.py
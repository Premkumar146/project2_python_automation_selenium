This is a Project Folder for "Project_Contact"

Go to Contact detail and fill
...
--------------------------
pytest -v -s --capture=sys --html=C:\Users\premk\workspace\Project_Six\report\test_prem.html testprem.py
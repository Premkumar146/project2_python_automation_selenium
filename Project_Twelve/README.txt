This is a Project Folder for "Project_Salary"

salary details and dirct deposite details
...
--------------------------
pytest -v -s --capture=sys --html=C:\Users\premk\workspace\Project_Twelve\report\test_prem.html testprem.py
